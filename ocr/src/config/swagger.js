// Centralized Swagger / OpenAPI configuration and module aggregator for OCR Service
const fs = require('fs');
...
const baseSwaggerSpec = {
  ...
  info: {
    ...
    version: '1.0.0',
    description:
      'High-performance Optical Character Recognition (OCR) microservice for multi-image text extraction and MongoDB indexing powered by Tesseract.js.',
    contact: {
      name: 'API Support',
    },
  },
    ...
    schemas: {
      HealthCheckResponse: {
        ...
        properties: {
          ...
          message: { type: 'string', example: 'OCR Microservice API' },
